...
public class Recibo extends Activity implements EMDKManager.EMDKListener, Scanner.StatusListener, Scanner.DataListener {
    ...
    public void BuscarSerial(String Serial) {
        try {
          conexion.ValidarReciboSerial(editTextSerial, editTextPartNo, editTextContainers, editTextPieces, Serial, usuario, lbl_Error );
